      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
        ...
        >
          <p>
            ...
            This domain serves as the primary ingress point for Tegota's deployment infrastructure.
          </p>
          <p>
            ...
            <a href="https://app.dokploy.cloud" className="inline-flex items-center gap-2 text-gray-900 dark:text-brand-text font-medium hover:text-black dark:hover:text-white transition-colors">
        ...
        >
          ...
          <p>
            Tegota thanks the Dokploy maintainers and contributors for creating a powerful, Docker-native deployment platform that enables teams to manage infrastructure at scale.                </p>
